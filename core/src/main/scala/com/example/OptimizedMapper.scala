...
object OptimizedMapper {
  ...
  private val artistToSong: Map[String,List[String]] = Map(
      ...
      "Eric Clapton" -> List("Walkin Blues", "San Francisco Bay Blues", "Leyla", "Nobody knows you when you're down and out"),
      ...
      "Megadeth" -> List("Holy Wars", "Symphony of Destruction", "Tornado of Soulds", "Hangar 18"),
